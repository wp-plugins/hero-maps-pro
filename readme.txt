...
Easily create your own Google Maps with extensive configuration options and a simple drag and drop interface
...
= 2.0.6 =
* Changed Google Maps to load over HTTPS
...
= 2.0.3 =
* Relative path fix for certain server environments
